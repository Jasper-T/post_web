...
write_portable_env() {
...

  {
    ...
    echo "# On Linux, leave it empty to default to the filesystem location that contains $PROJECT_NAME."
    echo "# Example: WEB_POST_FILESYSTEM_ROOT=/mnt/data"
